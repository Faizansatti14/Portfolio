...
const Experience = () => {
  const experiences = [
    ...
    {
      company: 'youbloom, Ireland',
      position: 'Frontend Developer',
      duration: '8/2025 - Present',
      location: 'Remote (Dublin, Ireland)',
      description: 'Engaged in building modern, responsive web interfaces using React, gaining hands-on experience in real-world frontend development while collaborating with an international team to deliver scalable and user-centric solutions.',
      achievements: [
       'Developed and maintained responsive UI components using React and modern JavaScript, Typescript',
       ...
       'Strengthened problem-solving, debugging, and code optimization skills through live projects'
      ],
      link: 'https://youbloom.com/'
    }
  ]
